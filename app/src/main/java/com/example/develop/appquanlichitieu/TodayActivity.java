...
public class TodayActivity extends Fragment {
    ...
    float TongThuChiCu,TongThuChiMoi,TongThuChi,tongChi,tongThu;
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(listTaiKhoan.size()<=0 || listTodayChi.size()<=0||listTodayThu.size()<=0)
        {
        ...
        else
        {
            ...
            {
                TongThuChi+=listTaiKhoan.get(i).getSoTienTaiKhoan();
            ...
            for (KhoangChi khoangChi: listTodayChi){
                ...
                tongChi+=khoangChi.getSoTienChi();
            }
            TongThuChi=0;
            ...
            {
                TongThuChi+=taiKhoan.getSoTienTaiKhoan();
            ...
            mChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
                ...
                public void onValueSelected(Entry e, Highlight h) {
                    ...
                    Toast.makeText(getActivity(),new DecimalFormat("###,###,###").
                            format(e.getY()) +" VND", Toast.LENGTH_SHORT).show();
                }
